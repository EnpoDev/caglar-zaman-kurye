            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-900">
                        <td class="px-6 py-4 text-sm text-black dark:text-white">Izgara Tavuk</td>
                        <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">Ana Yemekler</td>
                        <td class="px-6 py-4 text-sm text-black dark:text-white">₺85.00</td>
